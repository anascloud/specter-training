<footer class="w-full border-t bg-slate-50 border-slate-200">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto px-8 py-16">
        <div class="space-y-6">
            ...
            <p class="font-body-md text-slate-500 leading-relaxed">Authority in Education. Providing industry-recognized
                training and qualifications for the modern workforce.</p>
